...
INSERT INTO tickets (client_id, flight_id, seat)
VALUES
(1,1,'33B'),
(2,2,'8A'),
(3,3,'12F'),
...
-- Here we are selecting a particular clients flight's destinations
SELECT first_name, last_name, to_city from tickets JOIN clients ON client_id = clients.id JOIN flights ON flight_id = flights.id WHERE clients.id = 1;
